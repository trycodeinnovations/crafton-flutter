import 'package:crafton/Artist/UIdesign/Uidesign/acceptedorderpagedetails.dart';
...
class acceptedListPage extends StatelessWidget {
   const acceptedListPage({super.key, required this.acceptedlist,});
    final List<Artistviewordermodel> acceptedlist;
  @override
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Count & Customer Name
                    _buildOrderDetail('Customer Name', acceptedlist.first.customername),
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) => acceptedOrderDetailsPage(details:acceptedlist[index]),
                            ),
                          );
                        },
