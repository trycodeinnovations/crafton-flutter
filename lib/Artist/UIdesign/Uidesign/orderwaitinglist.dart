import 'package:crafton/Artist/UIdesign/Uidesign/orderwaitingpage.dart';
...
class OrdersListPage extends StatelessWidget {
   const OrdersListPage({super.key, required this.waitinglist,});
    final List<Artistviewordermodel> waitinglist;
  @override
  Widget build(BuildContext context) {
    
   
    // Sample data for demonstration (replace with actual data from Firebase)
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Count & Customer Name
                    _buildOrderDetail('Customer Name', waitinglist.first.customername),
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) => CustomerOrderDetailsPage(details:waitinglist[index]),
                            ),
                          );
                        },
