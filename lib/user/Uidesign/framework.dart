...
class Allframes extends StatelessWidget {
  const Allframes({super.key});
                    ...
                    builder: (context, provider, child) {
                      return Padding(
                        ...
                        child: GridView.builder(
                          ...
                          itemCount: provider.filteredframeList.length,
                          itemBuilder: (context, index) {
                            return InkWell(

                              onTap: () {
                           
      final works = provider.filteredframeList[index];
         ...
         final selectedArtist = customerviewartistlist
                  ...
                  Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => WorkFullDetails(
                                  work: provider.filteredframeList[index],artist:selectedArtist
                                ),
                              ));
                              ...
                              child: Container(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Stack(
                                    children: [
                                      Image.network(
                                        provider.filteredframeList[index].image,
                                        fit: BoxFit.cover,
                                      ...
                                      Positioned(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              provider.filteredframeList[index].subtype,
