                    ...
                    builder: (context, provider, child) {
                      return Padding(
                        ...
                        child: GridView.builder(
                          ...
                          itemCount: provider.filteredotherList.length,
                          itemBuilder: (context, index) {
                            return InkWell(

                              onTap: () {
                           
      final works = provider.filteredotherList[index];
         ...
         final selectedArtist = customerviewartistlist
                  ...
                  Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => WorkFullDetails(
                                  work: provider.filteredotherList[index],artist:selectedArtist
                                ),
                              ));
                              ...
                              child: Container(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Stack(
                                    children: [
                                      Image.network(
                                        provider.filteredotherList[index].image,
                                        fit: BoxFit.cover,
                                      ...
                                      Positioned(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              provider.filteredotherList[index].subtype,
